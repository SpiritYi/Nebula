...
abstract class LeoBackendMaster extends PageBase {
    ...
    public function __construct() {
        ...
        if (empty($this->userInfo) || $this->userInfo['admin_type'] != AdminUserNamespace::TYPE_ADMIN) {
            ...
            header('location:/leopassport?loc=' . urlencode($originUri));     //跳转到认证页面, 附带原先连接
        }

        PageBase::render('/leo_backend_master.php');
    }
