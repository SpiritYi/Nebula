...
class UserStockModel {
    ...
    public static function selectStockBySid($uid, $sid) {
        ...
        $handle = BaseStockModel::getDBHandle();
        $sqlString = SqlBuilderNamespace::buildSelectSql(self::$_TABLE, array('id', 'uid', 'sid', 'count', 'available_count', 'cost', 'loss_limit'),
    ...
    public static function selectStockList($uid) {
        ...
        $handle = BaseStockModel::getDBHandle();
        $sqlString = SqlBuilderNamespace::buildSelectSql(self::$_TABLE, array('uid', 'sid', 'count', 'available_count',
                 'cost', 'loss_limit', 'limit_alert_time'), array(array('uid', '=', $uid)), array());
        $res = DBMysqlNamespace::query($handle, $sqlString);
        return $res;
    }
